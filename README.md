...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-api-with-auth)

- JWT-protected API with [Cognito authentication](https://docs.stacktape.com/resources/user-auth-pools/), including
...
- Runs serverlessly in [AWS Lambda](https://docs.stacktape.com/compute-resources/lambda-functions/) behind an
  [HTTP API Gateway](https://docs.stacktape.com/resources/http-api-gateways/) with a Cognito JWT authorizer.
- Includes public and protected endpoints with automatic JWT validation.
...
```bash
stacktape init --starterId api-with-auth
```
...
[dev command](https://docs.stacktape.com/cli/commands/dev/). For example, to develop and debug lambda function `publicEndpoint`, you can use

```bash
stacktape dev --region <<your-region>> --stage <<stage>> --resourceName publicEndpoint
```
